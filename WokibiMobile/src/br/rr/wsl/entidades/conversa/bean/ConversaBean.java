package br.rr.wsl.entidades.conversa.bean;
...
public class ConversaBean {
	...
	private Integer clienteServidor;
	...
	public Integer getClienteServidor() {
		return clienteServidor;
	}
	
	public void setClienteServidor(Integer clienteServidor) {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((clienteServidor == null) ? 0 : clienteServidor.hashCode());
		result = prime * result 
	...
	public boolean equals(Object obj) {
		...
		if (clienteServidor == null) {
			if (other.clienteServidor != null)
				return false;
		} else if (!clienteServidor.equals(other.clienteServidor))
			return false;
		if (codigo == null) {
