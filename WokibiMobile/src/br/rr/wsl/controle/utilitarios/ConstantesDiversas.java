...
public class ConstantesDiversas {
	...
	public final static String PF_GUARDA_SENHA = "pf_1";
	public final static String PF_SERVICO_SERVIDOR = "pf_2";
	public final static String PF_SERVICO_SMS= "pf_3";
	public final static String PF_TELA_MENSAGEM = "pf_4";
	public final static String PF_TELA_CONVERSA = "pf_5";
	public final static String PF_TELA_PRINCIPAL = "pf_6";
	public final static String PF_AUDIO = "pf_7";
	...
	//Cliente Servidor
	public final static int CS_PORTA = 80;
	...
	public final static int HD_CONECTANDO_CLIENTE = 6;
